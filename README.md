...
# dependencies = [
#   "image-to-text-interrogator @ git+https://github.com/Wujidadi/image-to-text-interrogator@v0.4.1",
# ]
# ///

# As a dependency of a project
uv add "image-to-text-interrogator @ git+https://github.com/Wujidadi/image-to-text-interrogator@v0.4.1"
```
